...
namespace GCCC.BoardGame.Presentation.Views
{
    public sealed class PieceViewManager : MonoBehaviour
    {
        ...
        public void Initialize(Sprite sprite, GameSnapshot snapshot)
        {
            pieceSprite = sprite;
        ...
        private void RenderFromSnapshot(PieceId id, GameSnapshot snapshot)
        {
        ...
        {
            GameObject pieceObject = new GameObject($"Piece View {piece.Id.Value}");
            pieceObject.transform.SetParent(transform, false);
            PieceView view = pieceObject.AddComponent<PieceView>();
            view.Initialize(piece, pieceSprite, columns, rows);
